...
export default function AffiliateStatsDisplay({
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Commission Summary Cards - Requirements 10.3, 10.4 */}
      {commissions && (
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-green-600 mt-2">
                    {commissions.currency} {commissions.total_earned.toFixed(2)}
                  </p>
                </div>
                <div className="bg-green-100 rounded-full p-3">
                  <svg
            ...
            <div className="bg-white shadow-md rounded-lg p-6">
              <div>
                ...
                <p className="text-2xl font-bold text-yellow-600 mt-2">
                  {commissions.currency} {commissions.total_pending.toFixed(2)}
                </p>
              </div>
            </div>
            ...
            <div className="bg-white shadow-md rounded-lg p-6">
              <div>
                ...
                <p className="text-2xl font-bold text-blue-600 mt-2">
                  {commissions.currency} {commissions.total_approved.toFixed(2)}
                </p>
              </div>
            </div>
            ...
            <div className="bg-white shadow-md rounded-lg p-6">
              <div>
                ...
                <p className="text-2xl font-bold text-green-600 mt-2">
                  {commissions.currency} {commissions.total_paid.toFixed(2)}
                </p>
              </div>
            </div>
            ...
            <div className="bg-white shadow-md rounded-lg p-6">
              <div>
                ...
                <p className="text-2xl font-bold text-red-600 mt-2">
                  {commissions.currency} {commissions.total_cancelled.toFixed(2)}
                </p>
              </div>
            </div>
          </div>
